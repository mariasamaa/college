# LISTA DE EXERCÍCIOS DE FIXAÇÃO (5a)
    #Nessa lista você pode resolver os problemas utilizando o
    #que você preferir: if, else, elif, for, while, métodos da
    #lista e string, métodos embutidos no Python. Tente usar if
    #ternário e outras formas de resolver com menos linhas de código.
        #O objetivo é fixar todo o conteúdo já visto e 
        #desenvolver a lógica e o raciocínio com problemas
        #novos.
...
def dez(a, b):
    #Dados dois inteiros a e b retorna True
    #se um dos dois é 10 ou a soma é 10
...
def dista10(n):
    #Seja um inteiro n retorna True se a diferença absoluta
    #entre n e 100 ou n e 200 for menor ou igual a 10
        #dista10(93) -> True
        #dista10(90) -> True
        #dista10(89) -> False
