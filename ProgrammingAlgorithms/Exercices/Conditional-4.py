...
def potencia(base, expoente):
    ...
    # 'base ** expoente'
    # Argumentos: base (int): o valor base; expoente (int): o expoente;
    # Retorna: int: o resultado de base elevado ao expoente.
...
def crescimento_populacional(populacao1, populacao2, crescimento1, crescimento2):
    # Calcule quantos anos levará para a 'população1'ultrapassar a 'população2',
    # baseado em suas porcentagens de crescimento.
    # Argumentos:
    # populacao1 (int): a população da 1a cidade;
    # populacao2 (int): a população da 2a cidade;
    # crescimento1 (float): o percentual de cres anual da pop da 1a cidade;
    # crescimento2 (float): o percentual de cres anual da pop da 1a cidade;
    # Retorna:
    # int: a quantidade de anos que levará para a população da cidade 1
    # utrapassar a população da cidade 2.
...
def fibonacci(n):
    ...
    # Retorna:
    # uma lista de elementos inteiros correspondendo aos n primeiros
...
def fatorial(numero):
    # Calcule e retorne o fatorial do 'numero' informado, O fatorial é
    # o valor produtório dos valores menores ou iguais ao número
    # ex: fatorial de 4 é 4*3*2*1 e retorna 24.
    # Argumento: numero (int) = o número do qual se quer calcular o fatorial.
    # Retorna:int = o fatorial de numero.
...
def é_primo(valor):
    # Verifique se o valor informado é primo. Um número primo é
    # aquele que é divisível apenas por ele mesmo e por 1.
...
def quantidade_de_primos(inicio, fim):
    # Retorne a quantidade de primos entre os valores
    # informados, incluindo os limites.
    # Argumentos:
    # inicio (int): limite inferior;
    # fim (int): limite superior;
    # Retorna:
    # int: a quantidade de números primos dentro
    # do intervalo especificado.

    contador = inicio
    total = 0
    while contador <= fim:
        if é_primo(contador) == True:
            total += 1
        contador += 1
    return total
...
def serie1(n):
    ...
    # Retorna:
    # float: a soma dos valores da série,
...
def serie2(n):
    ...
    # n (int): o valor final da série;
    # Retorna:
    # float: a soma dos valores da série, segundo
    # a fórmula e o valor de n informados.
...
def serie_pi(n):
    ...
    #4/1 - 4/3 + 4/5 - 4/7 + ... - 4/m,
    # sendo informado o número n de iterações.
    # Argumento: n (int) = o valor final da série;
    # Retorna: float = o valor de pi calculado.
