...
# Faculdade 
Neste repositório, estão dispostos exercícios realizados durante o curso de bacharelado, separados por disciplina. No meu instituto, os professores usam a linguagem python para ensinar conceitos aos alunos, e os incentivam a aprender outras linguagens e a praticar esses conceitos com essas outras linguagens.
...
# College 
This repository contains exercises completed during the bachelor's degree course, separed by subjects. In my institute, teachers uses python language to teach concepts to the students, and encourage us to learn other languages and practice these concepts with that other languages.
